 ...
 * face North. Then, follow the provided sequence: either turn left (L) or right (R) 90 degrees,
 ...
 * For example:
 *
 * Following R2, L3 leaves you 2 blocks East and 3 blocks North, or 5 blocks away. R2, R2, R2 leaves
 * you 2 blocks due South of your starting position, which is 2 blocks away. R5, L5, R5, R3 leaves
 * you 12 blocks away. How many blocks away is Easter Bunny HQ?
 *
...
public class AOC2016_01 {
    public static void main(String[] args) {
        ...
        for (String move : input) {
            move = move.trim();
            final char direction = move.charAt(0);
            dir += (direction == 'R') ? 1 : 3;
            dir %= 4;
            final int size = Integer.parseInt(move.substring(1));
            for (int i = 0; i < size; i++, x += xInc[dir], y += yInc[dir]) {
                final String loc = x + "," + y;
